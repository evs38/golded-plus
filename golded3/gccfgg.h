...
const word CRC_DISPIMAGES       = 0x2541;
const word CRC_IMAGEPROTOCOL    = 0xD60A;
...
const word CRC_WRITEUCSHEADERS  = 0x6FD3;
const word CRC_LARGEHEADERTOBASE = 0x33C7;
const word CRC_XLATUTFAUTODETECT = 0xBB27;
...
const word CRC_XLATAREASET      = 0x150F;
const word CRC_XLATCONFIGSET    = 0x53EC;
