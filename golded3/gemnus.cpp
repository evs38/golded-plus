...
int GMenuWriteMsg::Run()
{
    ...
    {
    case TAG_DISKFILE:
        return WRITE_FILE|header;
    case TAG_PRINTER:
        return WRITE_PRINTER|header;
    case TAG_CLIPBRD:
        return WRITE_CLIPBRD|header;
    }
...
static void do_changexlatimport()
{
    ChangeXlatImport();
    wmenuinext(100);
}
...
static void SetCCListKeep()
{
    CFG->carboncopylist = CC_KEEP;
}
static void SetCCListNames()
{
    CFG->carboncopylist = CC_NAMES;
}
static void SetCCListVisible()
{
    CFG->carboncopylist = CC_VISIBLE;
}
static void SetCCListHidden()
{
    CFG->carboncopylist = CC_HIDDEN;
}
static void SetCCListRemove()
{
...
int GMenuCarbon::Run(GMsg* __msg)
{
    ...
    {
    case CC_KEEP:
        _listtag = TAG_CCLISTKEEP;
        break;
    case CC_NAMES:
        _listtag = TAG_CCLISTNAMES;
        break;
    case CC_VISIBLE:
        _listtag = TAG_CCLISTVISIBLE;
        break;
    case CC_HIDDEN:
        _listtag = TAG_CCLISTHIDDEN;
        break;
    case CC_REMOVE:
        _listtag = TAG_CCLISTREMOVE;
        break;
    }
...
static void SetXCListKeep()
{
    CFG->crosspostlist = CC_KEEP;
}
static void SetXCListNames()
{
    CFG->crosspostlist = CC_NAMES;
}
static void SetXCListVisible()
{
    CFG->crosspostlist = CC_VISIBLE;
}
static void SetXCListRemove()
{
...
int GMnuAreaDo::With(char* __title, char* __all, char* __marked, char* __current, int __full, char* __no, int __help)
{
    ...
    case TAG_UNSCANNED:
        return SCAN_UNSCANNED;
    case TAG_EXPORTQWK:
        return SCAN_EXPORTQWK;
    case TAG_IMPORTQWK:
        return SCAN_IMPORTQWK;
    case TAG_EXPORTSOUP:
        return SCAN_EXPORTSOUP;
    case TAG_IMPORTSOUP:
        return SCAN_IMPORTSOUP;
    }
...
int GMenuSChecker::Run(CSpellChecker &schecker, const char *word)
{
    ...
    else if ((finaltag > TAG_LANG) && (finaltag < TAG_MORE))
    {
        ...
        {
            XlatSnap save_xlat = XlatSnapshot(); // schecker.Load() changes the charset conversion in force
