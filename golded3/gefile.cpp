...
inline bool invalidfilechar(char ch)
{
    return not isascii(ch&0xff) or strchr(CFG__frqinvfilechars, ch);
}
...
bool gfileselect::handle_key()
{
    ...
    case KK_FileMark:
        ...
        cursor_down();
        break;
    case KK_FileGotoPrev:
        precursor();
        cursor_up();
        break;
    case KK_FileGotoNext:
        precursor();
        cursor_down();
        break;
    case KK_FileGotoFirst:
        precursor();
        cursor_first();
        break;
    case KK_FileGotoLast:
        precursor();
        cursor_last();
        break;
